...
export default function Hero() {
    return (
        <section className="relative bg-[#06090f] text-white overflow-hidden">
            ...
            {/* CONTENT */}
            <div className="relative max-w-12xl mx-auto px-6 pt-24 pb-28 grid md:grid-cols-2 gap-10 items-center
            bg-none
    ...
    md:bg-no-repeat
          ...
          bg-blue-900/40 border border-blue-700 text-sm">
                    ...
                    <p className="mt-6 text-gray-300 max-w-lg">
                        Enter with $1000 and trade firm capital under clear
                        performance guidelines. Scale up as you prove consistency.
                    </p>
